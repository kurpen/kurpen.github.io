...
class Auth extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array('lokale_model','rezerwacja_model'));
	...
	public function edit_user($id)
	{
			   ...
			   if($this->ion_auth->update($user->id, $data))
			    {
					...
					else
					{
						...
						$this->db->set('pic', $pic);
						$this->db->where('id', $user->restaurant_id);
						$this->db->update('lokale');
		...
		$this->data['miasta'] = $this->lokale_model->get_miasta();
		$this->data['lokal'] = $this->lokale_model->get_lokal_id($this->data['user']->restaurant_id);
